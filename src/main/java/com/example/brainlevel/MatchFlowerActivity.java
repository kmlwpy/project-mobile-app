...
public class MatchFlowerActivity extends AppCompatActivity {
    public TextView scoreflower;
    ...
    int flo101,flo102,flo103,flo104,flo105,flo106,flo107,flo108,flo109,flo110,
            flo201,flo202,flo203,flo204,flo205,flo206,flo207,flo208,flo209,flo210;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_match_flower);
        scoreflower = (TextView) findViewById(R.id.scoreflower);
    ...
    private void doStuff(ImageView iv,int card){
        ...
        if(cardsArray[card] == 101) {
            iv.setImageResource(flo101);
        }
        else if (cardsArray[card] == 102) {
            iv.setImageResource(flo102);
        }
        else if (cardsArray[card] == 103) {
            iv.setImageResource(flo103);
        }
        else if (cardsArray[card] == 104) {
            iv.setImageResource(flo104);
        }
        else if (cardsArray[card] == 105) {
            iv.setImageResource(flo105);
        }
        else if (cardsArray[card] == 106) {
            iv.setImageResource(flo106);
        }
        else if(cardsArray[card] == 107) {
            iv.setImageResource(flo107);
        }
        else if (cardsArray[card] == 108) {
            iv.setImageResource(flo108);
        }
        else if (cardsArray[card] == 109) {
            iv.setImageResource(flo109);
        }
        else if (cardsArray[card] == 110) {
            iv.setImageResource(flo110);
        }
    ...
    private void calculate(){
        ...
        if(firstCard == secondCard){
            ...
            if(scoreflower.getLineCount() == 1){
                playerPoints++;
                scoreflower.setText(" "+playerPoints*100);
            }
        } else {
    ...
    private void checkEnd() {
        if (iv_11.getVisibility() == View.INVISIBLE &&
            ...
            AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(MatchFlowerActivity.this);
    ...
    private void frontOfCardsResources (){
        flo101 = R.drawable.flo101;
        flo102 = R.drawable.flo102;
        flo103 = R.drawable.flo103;
        flo104 = R.drawable.flo104;
        flo105 = R.drawable.flo105;
        flo106 = R.drawable.flo106;
        flo107 = R.drawable.flo107;
        flo108 = R.drawable.flo108;
        flo109 = R.drawable.flo109;
        flo110 = R.drawable.flo110;
        flo201 = R.drawable.flo101;
        flo202 = R.drawable.flo102;
        flo203 = R.drawable.flo103;
        flo204 = R.drawable.flo104;
        flo205 = R.drawable.flo105;
        flo206 = R.drawable.flo106;
        flo207 = R.drawable.flo107;
        flo208 = R.drawable.flo108;
        flo209 = R.drawable.flo109;
        flo210 = R.drawable.flo110;
