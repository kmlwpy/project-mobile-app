...
public class MatchFruitActivity extends AppCompatActivity {
    public TextView scorefruit;
    ...
    int fruit101,fruit102,fruit103,fruit104,fruit105,fruit106,fruit107,fruit108,fruit109,fruit110,
            fruit201,fruit202,fruit203,fruit204,fruit205,fruit206,fruit207,fruit208,fruit209,fruit210;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_match_fruit);
        scorefruit = (TextView) findViewById(R.id.scorefruit);
    ...
    private void doStuff(ImageView iv,int card){
        ...
        if(cardsArray[card] == 101) {
            iv.setImageResource(fruit101);
        }
        else if (cardsArray[card] == 102) {
            iv.setImageResource(fruit102);
        }
        else if (cardsArray[card] == 103) {
            iv.setImageResource(fruit103);
        }
        else if (cardsArray[card] == 104) {
            iv.setImageResource(fruit104);
        }
        else if (cardsArray[card] == 105) {
            iv.setImageResource(fruit105);
        }
        else if (cardsArray[card] == 106) {
            iv.setImageResource(fruit106);
        }
        else if(cardsArray[card] == 107) {
            iv.setImageResource(fruit107);
        }
        else if (cardsArray[card] == 108) {
            iv.setImageResource(fruit108);
        }
        else if (cardsArray[card] == 109) {
            iv.setImageResource(fruit109);
        }
        else if (cardsArray[card] == 110) {
            iv.setImageResource(fruit110);
        }
    ...
    private void calculate(){
        ...
        if(firstCard == secondCard){
            ...
            if(scorefruit.getLineCount() == 1){
                playerPoints++;
                scorefruit.setText(" "+playerPoints*100);
            }
        } else {
    ...
    private void checkEnd() {
        if (iv_11.getVisibility() == View.INVISIBLE &&
            ...
            AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(MatchFruitActivity.this);
    ...
    private void frontOfCardsResources (){
        fruit101 = R.drawable.fruit101;
        fruit102 = R.drawable.fruit102;
        fruit103 = R.drawable.fruit103;
        fruit104 = R.drawable.fruit104;
        fruit105 = R.drawable.fruit105;
        fruit106 = R.drawable.fruit106;
        fruit107 = R.drawable.fruit107;
        fruit108 = R.drawable.fruit108;
        fruit109 = R.drawable.fruit109;
        fruit110 = R.drawable.fruit110;
        fruit201 = R.drawable.fruit101;
        fruit202 = R.drawable.fruit102;
        fruit203 = R.drawable.fruit103;
        fruit204 = R.drawable.fruit104;
        fruit205 = R.drawable.fruit105;
        fruit206 = R.drawable.fruit106;
        fruit207 = R.drawable.fruit107;
        fruit208 = R.drawable.fruit108;
        fruit209 = R.drawable.fruit109;
        fruit210 = R.drawable.fruit110;
