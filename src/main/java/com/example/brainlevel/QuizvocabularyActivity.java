...
public class QuizvocabularyActivity extends AppCompatActivity {
    public Button ans1,ans2,ans3,ans4;
    public TextView score,question;
    public Questionsvocabulary mQuestions = new Questionsvocabulary();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_quizvocabulary);
